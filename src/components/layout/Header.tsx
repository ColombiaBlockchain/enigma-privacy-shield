...
import { Globe, HelpCircle, Wallet, ChevronDown, Power } from 'lucide-react';
import { cn } from '@/lib/utils';

export const Header: React.FC = () => {
  const { language, setLanguage, network, setNetwork, wallet, setWallet } = useApp();
      ...
      <header className="sticky top-0 z-50 glass backdrop-blur-glass border-b border-glass-border">
        <div className="container mx-auto px-4 h-16 flex items-center justify-between">
          ...
          <Link to="/" className="flex items-center space-x-3">
            ...
            <span className="text-base font-bold">{t('app_title')}</span>
          </Link>
